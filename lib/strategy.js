...
Strategy.prototype.authenticate = function(req, options) {
  ...
  var cookie = req.cookies[this._key];
  ...
  function verified(err, user, info) {
    ...
    function issued(err, val) {
      ...
      // TODO: Add way to configure cookie options
      res.cookie(self._key, val, { maxAge: 900000, httpOnly: true });
